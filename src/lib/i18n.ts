...
const en: Dict = {
  ...
  mapTitle: 'Map your columns',
  mapHelp: "Match your file's columns to the standard fields. * required.",
  applyMapping: 'Apply Mapping',
  colNone: '— none —',
  domainColumns: 'Domain columns',
  mapFacilityName: 'Facility Name *',
  mapReportingDate: 'Reporting Date *',
...
const fr: Dict = {
  ...
  mapTitle: 'Associez vos colonnes',
  mapHelp: 'Associez les colonnes de votre fichier aux champs standard. * requis.',
  applyMapping: 'Appliquer',
  colNone: '— aucune —',
  domainColumns: 'Colonnes de domaine',
  mapFacilityName: "Nom de l'établissement *",
  mapReportingDate: 'Date de rapport *',
...
const es: Dict = {
  ...
  mapTitle: 'Asigne sus columnas',
  mapHelp: 'Asigne las columnas de su archivo a los campos estándar. * obligatorio.',
  applyMapping: 'Aplicar asignación',
  colNone: '— ninguna —',
  domainColumns: 'Columnas de dominio',
  mapFacilityName: 'Nombre del establecimiento *',
  mapReportingDate: 'Fecha de informe *',
